                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
                        ...
                        {isProcessing && (
                            <div className="frost-card p-6">
                                ...
                                <div className="step-indicator">
                                    <div className={`step ${currentStep === "prove" ? "active" : currentStep === "transfer" ? "completed" : ""}`}>
                                        <div className="step-circle">1</div>
                                        <span className="text-sm">Generate Proof</span>
                                    </div>
                                    <div className="step-connector" />
                                    <div className={`step ${currentStep === "transfer" ? "active" : ""}`}>
                    ...
                    <aside className="frost-card p-6 h-max">
                        ...
                        <div className="space-y-3">
                            ...
                            <SummaryRow
                                label="To"
                                value={recipient ? `${recipient.slice(0, 8)}...${recipient.slice(-6)}` : "Not set"}
                                muted
                            />
                            <SummaryRow
                                label="Amount"
